...
import cn.smbms.tools.SecurityUtils;
...
public class UserServlet extends HttpServlet {
	...
	private void updatePwd(HttpServletRequest request, HttpServletResponse response)
		...
		String pass=SecurityUtils.md5Hex(newpassword);
		boolean flag = false;
		if(o != null && !StringUtils.isNullOrEmpty(newpassword)){
			UserService userService = new UserServiceImpl();
			flag = userService.updatePwd(((User)o).getId(),pass);
			if(flag){
	...
	private void getPwdByUserId(HttpServletRequest request, HttpServletResponse response)
		...
		if(null == o ){//session过期
			...
			String pass=SecurityUtils.md5Hex(oldpassword);
			if(pass.equals(sessionPwd)){
	...
	private void add(HttpServletRequest request, HttpServletResponse response)
		...
		String address = request.getParameter("address");
		String userRole = request.getParameter("userRole");
		String pass=SecurityUtils.md5Hex(userPassword);
		User user = new User();
